<template>
  <div>
    ...
    <section class="content">
      <el-row :gutter="20" style="margin-top: 30px;margin-left: 20px">
        <el-col :span="4">
        ...
        <el-col :span="2" :offset="8">
          <el-button type="success" icon="plus" style="width: 130px"
                     @click="runningStatusVisible = true">添加黑名单
          </el-button>
        </el-col>
      </el-row>
      ...
      <el-dialog title="添加黑名单" :visible.sync="runningStatusVisible">
  ...
  export default {
    ...
    methods: {
      ...
      addImsi() {
        ...
        this.$post("bwTerminate/addBlack", this.device, "添加成功", "添加失败")
          .then(() => {
            this.getData();
